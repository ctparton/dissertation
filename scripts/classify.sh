...
python face_classification.py --b 512 --layers 8 --lr 0.001
python face_classification.py --b 512 --layers 8 --lr 0.0001
python face_classification.py --b 512 --layers 8 --lr 0.00001
python face_classification.py --b 512 --layers 8 --lr 0.000001
python face_classification.py --b 512 --layers 8 --lr 0.0000001
python face_classification.py --b 512 --layers 8 --lr 0.00000001
